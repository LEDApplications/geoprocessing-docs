...
|1
|label
|A high level label given as reference (e.g. test1)

|2
|description
|A text based explanation of what the test accomplishes
...
[cols="1,2,5", options="header"] 
.count_does_not_exist.bash arguments
|===
|Order
|Name
|Description
...
|5
|wherecase
|A SQL statement to be passed to the where clause
|===
...
|4
|firstselection
|A SQL statement or schema.table passed to the FROM clause
